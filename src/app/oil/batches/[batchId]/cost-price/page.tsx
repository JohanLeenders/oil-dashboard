          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Leverancier</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {jointCosts.map((jc) => (
                <tr key={jc.id}>
                  <td className="px-4 py-3 text-sm text-gray-900">{jc.cost_type}</td>
                  <td className="px-4 py-3 text-sm text-gray-600">{jc.supplier || '-'}</td>
                  <td className="px-4 py-3 text-sm text-gray-600">{jc.invoice_ref || '-'}</td>
        ...
        {splitoffData.length === 0 ? (
          ...
          <>
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Onderdeel</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Gewicht (kg)</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Marktprijs/kg</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Marktwaarde</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Allocatie %</th>
                  <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Toegewezen</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {splitoffData.map((s) => (
      ...
      >
        ...
        <div className="bg-gray-50 rounded p-4">
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-700">Totaal verwerkingskosten deze batch:</span>
            <span className="text-lg font-bold text-gray-900">{formatEur(totalProcessingCosts)}</span>
          </div>
        </div>
      </CostStep>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Onderdeel</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Split-off/kg</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">+ Verwerking/kg</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">= NRV/kg</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Totaal</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {nrvData.map((n, i) => (
