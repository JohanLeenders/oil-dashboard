DO $$
BEGIN
  EXECUTE '-- Wave 8: Seed article numbers from Storteboom bestelschema
...
ON CONFLICT (product_id, location, article_type) DO NOTHING';
  EXECUTE '-- OH Haasjes: vacuum 514298, niet_vacuum 598328
INSERT INTO product_article_numbers (product_id, location, article_type, article_number, packaging_size)
SELECT p.id, ''nijkerk'', ''vacuum'', ''514298'', NULL
FROM products p WHERE p.sku_code = ''OH-HAAS-VAC-001''
ON CONFLICT (product_id, location, article_type) DO NOTHING';
  EXECUTE 'INSERT INTO product_article_numbers (product_id, location, article_type, article_number, packaging_size)
SELECT p.id, ''nijkerk'', ''niet_vacuum'', ''598328'', NULL
FROM products p WHERE p.sku_code = ''OH-HAAS-VAC-001''
ON CONFLICT (product_id, location, article_type) DO NOTHING';
  EXECUTE '-- OH flt half, zonder vel zonder haas: vacuum 540457, niet_vacuum 540327
INSERT INTO product_article_numbers (product_id, location, article_type, article_number, packaging_size)
...
FROM products p WHERE p.sku_code = ''OH-FILET-VAC-001''
ON CONFLICT (product_id, location, article_type) DO NOTHING';
  EXECUTE '-- Dijfilet 15 kg vacuum: vacuum 392940, niet_vacuum 392841
INSERT INTO product_article_numbers (product_id, location, article_type, article_number, packaging_size)
...
FROM products p WHERE p.sku_code = ''OH-DIJ-VAC-001''
ON CONFLICT (product_id, location, article_type) DO NOTHING';
  EXECUTE '-- Kipfilet blokjes 10-15: vacuum 514281, niet_vacuum 513222
INSERT INTO product_article_numbers (product_id, location, article_type, article_number, packaging_size)
...
FROM products p WHERE p.sku_code = ''OH-DRUMVL-VAC-001''
ON CONFLICT (product_id, location, article_type) DO NOTHING';
  EXECUTE '-- Filet zonder vel, zonder haas 195-220: niet_vacuum 540617
INSERT INTO product_article_numbers (product_id, location, article_type, article_number, packaging_size)
SELECT p.id, ''nijkerk'', ''niet_vacuum'', ''540617'', NULL
FROM products p WHERE p.sku_code = ''OH-FILET-VAC-002''
ON CONFLICT (product_id, location, article_type) DO NOTHING';
  EXECUTE '-- Offcuts: niet_vacuum 528356
INSERT INTO product_article_numbers (product_id, location, article_type, article_number, packaging_size)
